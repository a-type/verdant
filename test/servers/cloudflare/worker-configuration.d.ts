/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8421523adde564dbcdb47deb81f14620)
// Runtime types generated with workerd@1.20250924.0 2025-09-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VerdantLibrary";
	}
	interface Env {
		TOKEN_SECRET: "notsecret";
		PORT: string;
		VERDANT_LIBRARY: DurableObjectNamespace<import("./src/index").VerdantLibrary>;
		VERDANT_BUCKET: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOKEN_SECRET" | "PORT">> {}
}
