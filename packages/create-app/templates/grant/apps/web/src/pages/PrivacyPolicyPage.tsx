		...
		<PageContent>
			...
			<div className="color-accent-ink bg-accent-wash p-3 rounded-md">
				<p>
					...
					privacy policy, but if you're wondering, {{ todo }} collects very
					little data, and most of it is what you provide if you choose to sign
				...
				<p>
					...
					Additionally, all the data you put into {{ todo }} will be stored
					{/*,
					including your list, categories, and recipes*/}
					. This is simply necessary in order to synchronize it. You still own
					your data, see <TextLink to="/tos">the Terms and Conditions</TextLink>
				</p>
			</div>
			...
			<ul>
				...
				<li>
					<p>
						<strong>Application</strong> refers to {{ todo }}, the software
