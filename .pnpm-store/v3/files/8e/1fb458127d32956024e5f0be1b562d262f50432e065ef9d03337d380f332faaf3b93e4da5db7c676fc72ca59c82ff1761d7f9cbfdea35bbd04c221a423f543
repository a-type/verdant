...
var _structuredClone = _interopRequireDefault(require("./lib/structuredClone.js"));
...
class FDBCursor {
  ...
  _iterate(key, primaryKey) {
    const sourceIsObjectStore = this.source instanceof _FDBObjectStore.default; // Can't use sourceIsObjectStore because TypeScript
    ...
    if (!foundRecord) {
      ...
      if (sourceIsObjectStore) {
        this._primaryKey = (0, _structuredClone.default)(foundRecord.key);

        if (!this._keyOnly && this.toString() === "[object IDBCursorWithValue]") {
          this.value = (0, _structuredClone.default)(foundRecord.value);
        }
      } else {
        this._primaryKey = (0, _structuredClone.default)(foundRecord.value);
        ...
        if (!this._keyOnly && this.toString() === "[object IDBCursorWithValue]") {
          ...
          this.value = (0, _structuredClone.default)(value);
        }
      }
  ...
  update(value) {
    ...
    const clone = (0, _structuredClone.default)(value);
